window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function ArchiveSettingsSection({ close }) {
      ...
      return React.createElement('section', { className: 'dsh-archive-settings' },
        ...
        React.createElement('button', { type: 'button', className: 'dsh-archive-settings__open', onClick: openManager }, '打开归档管理'))
    }
    ...
    const css = `
    .dsh-archive-settings{box-sizing:border-box;max-width:720px;color:var(--dsw-alias-label-primary);display:flex;flex-direction:column;align-items:flex-start;gap:14px}.dsh-archive-settings__hero{display:flex;align-items:center;gap:12px}.dsh-archive-settings__mark,.dsh-archive-page__title-mark{display:flex;align-items:center;justify-content:center;flex:none;border-radius:10px;background:color-mix(in srgb,var(--dsw-alias-brand-primary,#4f7cff) 14%,transparent);color:var(--dsw-alias-brand-primary,#4f7cff)}.dsh-archive-settings__mark{width:42px;height:42px}.dsh-archive-settings h2{margin:0;font-size:19px;line-height:27px}.dsh-archive-settings__open{min-width:138px;height:36px;border:0;border-radius:18px;padding:0 16px;display:inline-flex;align-items:center;justify-content:center;background:var(--dsw-alias-brand-primary);color:var(--dsw-alias-bg-base);font:inherit;font-weight:600;cursor:pointer;transition:opacity .16s ease}.dsh-archive-settings__open:hover{opacity:.88}.dsh-archive-settings__open:focus-visible{outline:2px solid var(--dsw-alias-label-primary);outline-offset:2px}
    ...
    @media (max-width:640px){.dsh-archive-page__header{padding:12px 14px}.dsh-archive-page__actions .is-secondary{width:36px;padding:0;font-size:0}.dsh-archive-page__actions .is-secondary svg{width:17px;height:17px}.dsh-archive-page__main{padding:18px 12px 36px}.dsh-archive-capability{flex-direction:column;gap:2px}.dsh-archive-row{align-items:flex-start;flex-wrap:wrap}.dsh-archive-row__body{width:calc(100% - 49px)}.dsh-archive-row__restore{margin-left:49px}}
