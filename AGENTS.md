...
- UI must remain additive through `settings.section` and `shell.overlay`; do not add a sidebar entry, replace shell-level slots, or hard-code DSH DOM selectors.
