...
- UI must remain additive through `settings.section`, `sidebar.footer.action`, and `shell.overlay`; do not replace shell-level slots or hard-code DSH DOM selectors.
